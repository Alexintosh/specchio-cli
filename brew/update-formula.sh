...
ARM64_SHA256=$(shasum -a 256 specchio-setup-arm64 | awk '{print $1}')
X64_SHA256=$(shasum -a 256 specchio-setup-x64 | awk '{print $1}')
...
sed -i.bak "s/REPLACE_ARM64_SHA256/$ARM64_SHA256/g" "$BREW_DIR/specchio-setup.rb"
sed -i.bak "s/REPLACE_X86_64_SHA256/$X64_SHA256/g" "$BREW_DIR/specchio-setup.rb"

# Clean up backup
rm -f "$BREW_DIR/specchio-setup.rb.bak"
...
echo "2. Test the formula: brew install --build-from-source $BREW_DIR/specchio-setup.rb"
